...
{
    [HarmonyPatch(typeof(SavedGame), "Push", new[] { typeof(GameModel), typeof(PlacedGadgetV08), typeof(GadgetSiteModel) })]
    internal static class SavedGameIgnoreNullGadgetsPatch
    {
