...
namespace SRML.SR
{
    public static class SecretStyleRegistry
    {
        ...
        public static bool IsSecretStylesInstalled()
        {
            if (SRModLoader.CurrentLoadingStep == SRModLoader.LoadingStep.PRELOAD)
                throw new LoadingStepException("Cannot check if secret styles is installed during the PreLoad step");
