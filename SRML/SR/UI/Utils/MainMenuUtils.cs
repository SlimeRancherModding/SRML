...
namespace SRML.SR.UI.Utils
{
    public static class MainMenuUtils
    {
        ...
        public static GameObject AddMainMenuButton(MainMenuUI mainMenu, string name, string text, Action onClicked)
        {
            ...
            MonoBehaviour.Destroy(g.GetComponentInChildren<XlateText>());
