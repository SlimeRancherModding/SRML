...
{
    [HarmonyPatch(typeof(SlimeAppearanceDirector), nameof(SlimeAppearanceDirector.UnlockAppearance))]
    ...
    [HarmonyPatch(typeof(SlimeAppearanceDirector), nameof(SlimeAppearanceDirector.UpdateChosenSlimeAppearance))]
